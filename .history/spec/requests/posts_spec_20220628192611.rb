...
RSpec.describe 'Posts API', type: :request do
  ...
  describe 'POST /posts' do
    it 'should create a new post' do
      ...
      post '/api/v1/posts', params: { post: { title: 'Post Title', body: 'Post body', user: user: FactoryBot.create(:user, first_name: 'Odell', last_name: 'Test', email: 'odell@example123132.com', username: 'Testuser1werfw', password: 'password')} }
