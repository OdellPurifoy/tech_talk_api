...
RSpec.describe 'Posts API', type: :request do
  ...
  describe 'DELETE /posts/:id' do
    let(:post) { FactoryBot.create(:post, title: 'Test title', body: 'Test body', user: FactoryBot.create(:user, first_name: 'Odell', last_name: 'Test', email: 'odell@example1132.com', username: 'Testuser1wert', password: 'password')) }
